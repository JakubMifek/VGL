...
class FloorPlan {
    companion object {
        ...
        private val floorPlanPatternWeights = PatternWeights2D(
            TemplateHolder.floorPlan,
            2,
        ...
        fun generate(width: Int, height: Int, seed: Int = Random.nextInt()): Array<Array<PaletteKeys>> {
